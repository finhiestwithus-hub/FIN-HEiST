...
export default function Footer({ onOpenModal }: FooterProps) {
 ...
 <div>
 <span className="text-[10px] uppercase text-slate-500 font-mono block">Direct Phone</span>
 <a href={`tel:${COMPANY_INFO.phone.replace(/\s+/g, '')}`} className="font-semibold text-white hover:text-amber-400 font-mono">
 {COMPANY_INFO.phone}
 </a>
 </div>
 </div>
 ...
 <div>
 <span className="text-[10px] uppercase text-slate-500 font-mono block">Official Email</span>
 <a href={`mailto:${COMPANY_INFO.email}`} className="font-semibold text-white hover:text-emerald-400">
 {COMPANY_INFO.email}
 </a>
 </div>
 </div>
 ...
 <div>
 <span className="text-[10px] uppercase text-slate-500 font-mono block">Instagram</span>
 <a href={COMPANY_INFO.instagramUrl} target="_blank" rel="noopener noreferrer" className="font-semibold text-white hover:text-purple-400">
