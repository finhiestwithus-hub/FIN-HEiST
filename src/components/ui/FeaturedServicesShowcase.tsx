...
export default function FeaturedServicesShowcase({ onOpenModal }: FeaturedServicesShowcaseProps) {
  ...
  return (
    <section id="featured-services" className="py-28 bg-mesh-soft relative overflow-hidden border-t border-slate-200/80">
      ...
      <div className="absolute bottom-10 -right-32 w-96 h-96 rounded-full bg-yellow-500/10 blur-[150px] pointer-events-none animate-blob float-delay-2" />
      ...
      <div className="max-w-[1760px] w-full mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 relative z-10">
        ...
        <div className="group relative glass-card rounded-3xl p-7 sm:p-12 border-2 border-slate-200/90 hover:border-amber-400 shadow-[0_20px_70px_-15px_rgba(245,158,11,0.18)] overflow-hidden transition-all duration-700 transform hover:-translate-y-2 animate-card-pulse">
