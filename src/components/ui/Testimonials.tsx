    ...
    <section id="testimonials" ref={sectionRef} className="py-24 bg-mesh-soft border-t border-slate-200/80 relative overflow-hidden">
      ...
      >
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="group relative glass-card glass-card-hover rounded-3xl border-2 border-amber-500/30 shadow-2xl p-8 sm:p-12 overflow-hidden transition-all duration-700 ease-out hover:-translate-y-2.5 hover:scale-[1.015] hover:shadow-[0_25px_70px_-15px_rgba(245,158,11,0.25)] animate-card-pulse">
