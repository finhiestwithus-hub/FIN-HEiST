...
export default function WhyFinHeist() {
  ...
  return (
    <section id="why-us" className="py-28 bg-mesh-soft relative overflow-hidden border-t border-slate-200/80">
      {/* Top Gold Accent Bar */}
      ...
      <div className="absolute bottom-1/4 -right-32 w-96 h-96 rounded-full bg-yellow-500/10 blur-[140px] pointer-events-none animate-blob float-delay-3" />
      ...
      <div className="max-w-[1760px] w-full mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/15 border border-amber-500/30 text-sm font-bold text-amber-800 animate-card-tilt shadow-sm">
            ...
            <span>Why Fin-Heist Stands Apart</span>
          </div>
