...
export default function WhyFinHeist() {
    ...
    return (
        <section id="why-us" className="py-28 bg-mesh-soft relative overflow-hidden border-t border-slate-200/80 scroll-mt-24">
            ...
            <div className="max-w-[1760px] w-full mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 relative z-10">
                ...
                <div
                    ref={headerRef}
                    className={`text-center max-w-3xl mx-auto space-y-4 mb-16 transition-all duration-700 ease-out ${headerVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                        }`}
                >
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold font-poppins text-slate-900 tracking-tight">
                        The Smart Advantage for{' '}<br></br>
                ...
                <div ref={gridRef} className="flex overflow-x-auto md:grid md:overflow-visible md:grid-cols-3 lg:grid-cols-4 gap-6 pb-8 md:pb-0 snap-x snap-mandatory md:snap-none [scrollbar-width:none] [&::-webkit-scrollbar]:hidden scroll-smooth -mx-4 px-4 sm:mx-0 sm:px-0">
 ...
 shrink-0 w-[85vw] sm:w-[350px] md:w-auto snap-center md:snap-align-none
