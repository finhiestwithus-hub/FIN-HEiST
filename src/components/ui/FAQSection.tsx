...
export default function FAQSection() {
 ...
 <div
 ref={headerRef}
 className={`text-center max-w-3xl mx-auto space-y-3 mb-14 transition-all duration-700 ease-out ${
 ...
 <span className={`text-xs font-bold shrink-0 px-2.5 py-1 rounded-lg border font-mono ${
 isOpen ? 'bg-amber-500/20 text-amber-800 border-amber-400/50' : 'bg-slate-100 text-slate-600 border-slate-200'
 }`}>
 {faq.category}
 </span>
...
`}
 ...
 <p className="text-sm text-slate-600 font-medium mt-1">Chat directly with our CA specialists on WhatsApp for instant guidance.</p>
 </div>
 <a
