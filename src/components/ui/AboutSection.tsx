...
export default function AboutSection({ onOpenModal }: AboutSectionProps) {
 ...
 return (
 <section id="about" className="py-24 bg-mesh-soft border-t border-slate-200/80 relative overflow-hidden scroll-mt-24">
 {/* Top accent strip */}
 ...
 <div
 ref={leftRef}
 className={`lg:col-span-6 relative transition-all duration-700 ease-out ${
