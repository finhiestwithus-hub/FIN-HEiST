        ...
        <section id="about" className="py-16 lg:py-24 bg-mesh-soft border-t border-slate-200/80 relative overflow-hidden scroll-mt-24">
            ...
            <div className="max-w-[1760px] w-full mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                    ...
                    <div
                        ref={leftRef}
                        className={`lg:col-span-6 relative transition-all duration-700 ease-out ${leftVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'
                            }`}
                    >
                        {/* Background photo */}
                    ...
                    <div
                        ref={rightRef}
                        className={`lg:col-span-6 space-y-8 transition-all duration-700 ease-out delay-150 ${rightVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
                            }`}
                    >
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                return (
                                    <div
                                        key={idx}
                                        className={`p-6 rounded-2xl glass-card glass-card-hover border border-slate-200/80 hover:border-amber-400/50 shadow-sm hover:shadow-lg transition-all flex items-start gap-4 ${idx === 0 ? ' ' : idx === 1 ? ' ' : ' '
                                            }`}
                                    >
