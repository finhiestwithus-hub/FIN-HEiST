                        ...
                        <div className="rounded-2xl glass-card glass-card-hover border border-slate-200/80 shadow-2xl overflow-hidden">
                            ...
                            <div className="bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 border-b border-amber-300 px-6 py-5 flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-900/80 font-medium mt-0.5">Secure, confidential submission directly to our team</p>
                                </div>
                                    ...
                                    <form onSubmit={(e) => validateAndSubmit(e, 'submit')} className="space-y-4">
                                        ...
                                        <div className="pt-3 grid grid-cols-1 sm:grid-cols-3 gap-3">
                                            ...
                                            <button
                                                ...
                                                className="py-3.5 px-4 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-bold text-xs sm:text-sm flex items-center justify-center gap-2 transition-all shadow-lg shadow-emerald-500/25"
                                            >
