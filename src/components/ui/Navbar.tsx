    ...
    <header className="fixed top-0 left-0 right-0 z-50 font-inter">
      ...
      <div className="hidden sm:flex bg-[#07080c] text-slate-300 px-4 sm:px-8 lg:px-12 xl:px-16 py-2.5 text-xs border-b border-amber-500/30 items-center justify-between shadow-inner">
        <div className="flex items-center flex-wrap gap-4 sm:gap-6">
          ...
          <div className="hidden md:flex items-center gap-1.5 text-slate-300 ml-1 sm:ml-2 border-l border-amber-500/30 pl-3">
            <span className="font-semibold text-amber-400/90 text-[10px] tracking-wider uppercase">GSTIN:</span>
            <span>05HFLPK7898D1ZT</span>
          </div>
        </div>
            ...
            {profile?.role === 'admin' ? (
              <>
                <button
                  ...
                  className={`flex items-center gap-2 text-sm font-semibold tracking-wide transition-all duration-200 relative py-1 ${adminActiveTab === 'enquiries' ? 'text-amber-600 font-extrabold' : 'text-slate-700 hover:text-amber-600'
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-2 text-sm font-semibold tracking-wide transition-all duration-200 relative py-1 ${adminActiveTab === 'news' ? 'text-amber-600 font-extrabold' : 'text-slate-700 hover:text-amber-600'
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-2 text-sm font-semibold tracking-wide transition-all duration-200 relative py-1 ${adminActiveTab === 'reviews' ? 'text-amber-600 font-extrabold' : 'text-slate-700 hover:text-amber-600'
                    }`}
                >
              ...
              navLinks.map((link) => {
                ...
                return (
                  <a
                    key={link.id}
                    href={link.href}
                    className={`text-sm font-semibold tracking-wide transition-all duration-200 relative py-1 ${isActive
            ...
            {profile?.role === 'admin' ? (
              <>
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-3 rounded-xl text-sm font-semibold transition-colors text-left ${adminActiveTab === 'enquiries' ? 'bg-amber-50 text-amber-700 border border-amber-200 font-bold' : 'text-slate-700 hover:bg-slate-50'
                    }`}
                >
                  <FileText className="w-4 h-4" /> Client Enquiries
                </button>
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-3 rounded-xl text-sm font-semibold transition-colors text-left ${adminActiveTab === 'news' ? 'bg-amber-50 text-amber-700 border border-amber-200 font-bold' : 'text-slate-700 hover:bg-slate-50'
                    }`}
                >
                  <Newspaper className="w-4 h-4" /> Manage Ticker
                </button>
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-3 rounded-xl text-sm font-semibold transition-colors text-left ${adminActiveTab === 'reviews' ? 'bg-amber-50 text-amber-700 border border-amber-200 font-bold' : 'text-slate-700 hover:bg-slate-50'
                    }`}
                >
                  <Star className="w-4 h-4" /> Manage Reviews
                </button>
              ...
              navLinks.map((link) => (
                <a
                  ...
                  className={`px-4 py-3 rounded-xl text-sm font-semibold transition-colors ${activeSection === link.id
