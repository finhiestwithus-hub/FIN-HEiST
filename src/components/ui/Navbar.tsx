...
export default function Navbar({ onOpenModal }: NavbarProps) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['home', 'services', 'about', 'leadership', 'why-us', 'dscr-calculator', 'testimonials', 'contact'];
  ...
  const navLinks = [
    ...
    { label: 'DSCR & Loans', href: '#dscr-calculator', id: 'dscr-calculator' },
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            {user ? (
              ...
              <button
                ...
                className="hidden sm:flex items-center gap-1.5 px-4 py-2 rounded-full bg-slate-900 hover:bg-slate-800 text-amber-400 border border-slate-800 font-poppins font-bold text-xs transition-all shadow-xs"
              >
            ...
            <div className="pt-3 border-t border-slate-200 mt-1 flex flex-col gap-2">
              ...
              {user ? (
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-slate-900 text-amber-400 font-poppins font-bold text-sm flex items-center justify-center gap-2 shadow-sm"
                >
                  <Lock className="w-4 h-4" />
                  <span>Client Login / Create Account</span>
                </button>
              )}
