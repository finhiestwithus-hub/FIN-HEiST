...
export default function Hero({ onOpenModal }: HeroProps) {
 ...
 const trustBadges = [
 { icon: '✔', label: 'Ddedicated Relationship Support' },
 ...
 {/* Main Headline */}
 <h1 className={`text-4xl sm:text-5xl lg:text-6xl font-extrabold font-poppins tracking-tight leading-[1.12] text-slate-900 transition-all duration-700 delay-200 transform ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
 }`}>
 ...
 {/* CTA Buttons */}
 <div className={`flex flex-wrap items-center gap-4 pt-2 transition-all duration-700 delay-500 transform ${isLoaded ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-10 scale-95'
 }`}>
 <button
 ...
 <a
 href="#services"
 className="px-7 py-4 rounded-xl glass-card hover:bg-white text-slate-800 hover:text-amber-600 font-semibold transition-all duration-300 transform hover:-translate-y-0.5 flex items-center gap-2 text-base shadow-md hover:shadow-lg border border-slate-300/80"
 >
 ...
 className="px-6 py-4 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-semibold transition-all duration-300 transform hover:-translate-y-0.5 flex items-center gap-2 text-base shadow-lg shadow-emerald-500/25"
 >
 ...
 <div className="hidden sm:flex absolute -top-5 -right-4 px-4 py-2.5 rounded-2xl bg-white border border-amber-200 text-xs font-bold text-amber-700 shadow-lg items-center gap-2 z-20">
 <ShieldCheck className="w-4 h-4 text-amber-600" />
 <span>CA Certified Workflow</span>
 </div>

 <div className="hidden sm:flex absolute -bottom-4 -left-4 px-4 py-2.5 rounded-2xl bg-white border border-emerald-200 text-xs font-bold text-emerald-700 shadow-lg items-center gap-2 z-20">
